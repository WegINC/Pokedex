function getTemplateOfPokemon(index) {
  ...
  function overlayTemplate(pokemonInfo, index) {
    return `
      <div id="contentOverlay" onclick="pauseOverlay(event)" class="bgOfInfo">
        <div class="mbTopBottom">
          <img onclick="prevPic(${index})" class="arrowNext" src="./assets/icons/arrowLeft.png">
  
          <div id="headInfo" class="headInfo">
        ...
        <div id="imageContainer" class="${pokemonInfo.types[0].type.name} overlayBgWidth">
          <img class="loadedImg" id="pokemonImage" src="${pokemonInfo.sprites.other.home.front_default}" alt="">
        </div>
  
        <div id="typesPicture"></div>
        ...
        <div id="moreAboutPokemon" class="mainInfo"></div>

        <div id="loadMoreAboutPokemon" class="mainInfo column"></div>
      </div>`;
  }
